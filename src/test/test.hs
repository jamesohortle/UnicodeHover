...
main = do
  ...
  -- Hexadecimal escapes.
  putStrLn "\
    \ \x0000 \x00000000 -> Null\
    \ \x0020\x00000020 ->  Space\
    \ \x0080\x00000080 -> Padding Character (alias)\
    \ \x1234\x00001234 -> ሴ Ethiopic Syllable See\
    \ \x0b87 \x00000b87 -> இ Tamil Letter I\
    \ \x0fda \x00000FDA -> ࿚ Tibetan Mark Trailing Mchan Rtags\
    \ \x32ff\x000032FF ->  Square Era Name Reiwa\
    \ \x50B7\x000050B7 -> 傷 Wound, injury; fall ill from (Unified CJK)\
    ...
    \ \x08BE\x000008BE ->  Arabic Letter Peh with Small V\
    \ \x10E80\x00010E80 ->  Yezidi Letter Elif\
    \ \x11900\x00011900 ->  Dives Akuru Letter A\
    \ \x18B01\x00018B01 ->  Khitan Small Script Character-18b01\
    \ \x10FB0\x00010FB0 ->  Chorasmian Letter Aleph\
